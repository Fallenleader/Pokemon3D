...
namespace Pokémon3D.Rendering
{
    static class Primitives
    {
        ...
        public static GeometryData GenerateQuadXZ(Vector3? offset = null, ushort? startIndex = null, Vector2? texCoordStart = null, Vector2? texCoordScale = null)
        {
            ...
            data.Vertices = new[]
            {
                new VertexPositionNormalTexture(baseOffset + new Vector3(-0.5f,  0.0f,  0.5f), Vector3.Up, startTexCoord + new Vector2(0.0f,1.0f) * scaleTexCoord),
                new VertexPositionNormalTexture(baseOffset + new Vector3(-0.5f,  0.0f, -0.5f), Vector3.Up, startTexCoord + new Vector2(0.0f,0.0f)* scaleTexCoord),
                new VertexPositionNormalTexture(baseOffset + new Vector3( 0.5f,  0.0f,  0.5f), Vector3.Up, startTexCoord + new Vector2(1.0f,1.0f)* scaleTexCoord),
                new VertexPositionNormalTexture(baseOffset + new Vector3( 0.5f,  0.0f, -0.5f), Vector3.Up, startTexCoord + new Vector2(1.0f,0.0f)* scaleTexCoord),
            };
