...
namespace Pokémon3D.My
{
    //The content of this class is here to supply access to the Visual Basic My namespace.
    //We mark this stuff as obsolete because we are trying to remove any usage of the My namespace in our new C# project.

    [Obsolete("Replace the My namespace usage with C# equivalents.")]
